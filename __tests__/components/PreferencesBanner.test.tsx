...
describe('PreferencesBanner', () => {
  ...
  it('renders with default title and description', () => {
    render(<PreferencesBanner options={mockOptions} onSubmit={mockOnSubmit} />);

    expect(screen.getByText('Set Your Preferences')).toBeInTheDocument();
    expect(screen.getByText('Help us personalize your experience by selecting your preferences below.')).toBeInTheDocument();
  });
  ...
  it('renders all preference options with labels and descriptions', () => {
    ...
    expect(screen.getByText('Answer my questions with images when appropriate')).toBeInTheDocument();
    expect(screen.getByText('Detailed Answers')).toBeInTheDocument();
    expect(screen.getByText('Provide more comprehensive responses')).toBeInTheDocument();
  });
  ...
  it('calls onSubmit with selected values when Save Preferences is clicked', async () => {
    ...
    expect(mockOnSubmit).toHaveBeenCalledWith(['visualResponse', 'detailedAnswers']);
  });
  ...
  it('renders dismiss button when onDismiss is provided', () => {
    render(<PreferencesBanner options={mockOptions} onSubmit={mockOnSubmit} onDismiss={mockOnDismiss} />);
  ...
  it('does not display error message when error is null', () => {
    render(<PreferencesBanner options={mockOptions} onSubmit={mockOnSubmit} error={null} />);
  ...
  it('displays error message when error is provided', () => {
    ...
    render(<PreferencesBanner options={mockOptions} onSubmit={mockOnSubmit} error={errorMessage} />);
  ...
  it('handles single option', async () => {
    ...
    render(<PreferencesBanner options={singleOption} onSubmit={mockOnSubmit} />);
  ...
  it('renders option without description', () => {
    ...
    render(<PreferencesBanner options={optionWithoutDescription} onSubmit={mockOnSubmit} />);
