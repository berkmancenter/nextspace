...
describe('ThreadedMessage Component', () => {
  ...
  it("shows (You) label on first reply if it's from current user", () => {
    const repliesWithCurrentUser = [{ ...mockReplies[0], pseudonym: 'User1' }, mockReplies[1]];
  ...
  it('renders feedback component for assistant messages when config is provided', () => {
    ...
    render(<ThreadedMessage {...defaultProps} message={assistantMessage} feedbackConfig={feedbackConfig} />);
  ...
  it('does not render feedback for non-assistant messages', () => {
    ...
    render(<ThreadedMessage {...defaultProps} feedbackConfig={feedbackConfig} />);
  ...
  it('does not render feedback when no feedbackConfig is provided', () => {
    ...
    render(<ThreadedMessage {...defaultProps} message={assistantMessage} />);
  ...
  it('passes initialRating from messageRatings map to MessageFeedback', () => {
    ...
    const { container } = render(
      <ThreadedMessage {...defaultProps} message={assistantMessage} feedbackConfig={feedbackConfig} />,
    );
  ...
  it('does not render feedback when message has no id', () => {
    ...
    render(<ThreadedMessage {...defaultProps} message={assistantMessageNoId} feedbackConfig={feedbackConfig} />);
  ...
  describe('IntersectionObserver and mark as read', () => {
    ...
    it('sets up IntersectionObserver when message has unread replies', () => {
      render(
        <ThreadedMessage {...defaultProps} replies={mockReplies} hasUnreadReplies={true} onMarkAsRead={mockOnMarkAsRead} />,
      );
    ...
    it('does not set up observer when onMarkAsRead is not provided', () => {
      render(<ThreadedMessage {...defaultProps} replies={mockReplies} hasUnreadReplies={true} onMarkAsRead={undefined} />);
