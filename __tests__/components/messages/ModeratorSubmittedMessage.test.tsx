...
describe('ModeratorSubmittedMessage Component', () => {
  ...
  it('applies blue background and left border styling', () => {
    ...
    const { container } = render(<ModeratorSubmittedMessage message={message} />);
  ...
  it('handles string body content', () => {
    ...
    expect(screen.getByText('Your question was submitted to the moderator')).toBeInTheDocument();
  });
});
