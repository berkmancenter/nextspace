 ...
 * three feedback buttons: Thumbs Down, Thumbs Up, and Mind Blown.
 */
export const MessageFeedback: FC<MessageFeedbackProps> = ({
  ...
  const feedbackOptions = [
    { text: "Thumbs Down", icon: <ThumbDownOutlined fontSize="small" /> },
    { text: "Thumbs Up", icon: <ThumbUpOutlined fontSize="small" /> },
    { text: "Mind Blown!", icon: <MindBlownIcon /> },
  ];
    ...
    <Box display="flex" flexDirection="column" gap="0.5rem" marginTop="0.5rem">
      ...
      >
        {feedbackOptions.map((option, index) => (
          <Tooltip key={option.text} title={option.text} arrow>
            <span>
              <Button
                ref={(el) => {
