          ...
          for (
            ...
            for (
              ...
              (i[m] === void 0 ? ((L = t.idf(this.invertedIndex[m], this.documentCount)), (i[m] = L)) : (L = i[m]),
                (C =
                  (L * ((this._k1 + 1) * g)) / (this._k1 * (1 - this._b + this._b * (c / this.averageFieldLength[a])) + g)),
                (C *= v),
                (C *= x),
...
`),
  ...
  function Te(t, e, n, r) {
    let i;
    if (
      (r === 1 ? (i = n?.nextElementSibling || t.firstElementChild) : (i = n?.previousElementSibling || t.lastElementChild),
      i !== n)
    ) {
      if (!i || i.role !== 'option') {
  ...
  async function Ve() {
    ...
    if ((i.classList.add('tsd-hierarchy'), ft(i, n, e), r.querySelectorAll('li').length == i.querySelectorAll('li').length))
      return;
